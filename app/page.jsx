...
const Home = () => {
  return (
    <section className="flex flex-col items-center max-w-7xl p-5 rounded-lg  w-[98%] mx-auto text-center ">
      ...
      <p className="text-2xl para_text dark:text-slate-100 mt-5 w-[90%] tracking-tight ">
        PROMPTAG, a remarkable and forward-thinking tool, emerges as an
        innovative solution designed for the contemporary world.
      </p>
      <Feed />
    </section>
  );
